...
//            new ArrayList<>(Arrays.asList("This Item is so error it will break your game","This is ERROR!")));
    ...
    public static ItemStack SPACE_STONE = createItem(getSkull(new ItemStack(Material.SKULL_ITEM), "d76c75f3-3bfd-4eb1" +
            ...
            new ArrayList<>(Arrays.asList("This Stone is taken from space","Abilities:")));
    // {display:{Name:"Gemstone Gauntlet (Maxed)"},SkullOwner:{Id:"c2286827-71ca-4bb9-a7c4-4f30e5ba6832",
    // Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNGRkODhiMmYxMWRkY2FkYmJhNDkwMzI2YTBiMWFiNDg3OGQ1M2RiYmIyNTViNzA0NjA0NzNkMmVhYmMwYzY4MiJ9fX0="}]}}}
